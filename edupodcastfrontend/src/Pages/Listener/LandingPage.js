          ...
          <div className="col-6">
            ...
            </p>
            {
              props.data == 'listenerhome' ?
                ...
                <div className="mt-5">
                  <button className="seelatestpodcast text-decoration-none"><Link className="text-light text-decoration-none" to="/creatorpodcastlisting" >Latest podcast</Link></button>
                ...
                </div> :<div> <h6>Welcome to the Podcast World !</h6><button className="seelatestpodcast text-decoration-none"><Link className="text-light text-decoration-none" to="/ListenerLogin" > Get Started</Link></button></div>
            }
          </div>
          <div className="col-6">
